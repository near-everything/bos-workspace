...
// This takes in functions from the Provider
// It needs items, 
  ...
  <>
    <Root>
      <div className="c__left">
        ...
        {/* We can gut this so that it is only for showing items and selecting them */}
        {/* Frankly, this is the only place that actually needs to know about any of the data */}

        {/* This is a navigation bar that takes in items, renders them as you like, etc */}
      </div>
      <div className="c__right" key={path}>
        {/* Then this has an editor and a viewer, that you can swap between.  */}
        {/*
